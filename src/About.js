        ...
        return (
            <Container>
                ...
                <Col>
                        ...
                        <p>Together we enjoy going out to restaurants throughout Philadelphia, especially new ones that seem impossible to get in to. We're lucky enough to live close to family and friends to visit as often as we can. We enjoy traveling and hope to do much more of it in the future. Perhaps our greatest passion though consists of eating takeout and binge-watching TV shows, like any modern romance.</p>
                        <p> Due to COVID-19, our wedding plans have changed multiple times. After a very tough 6 months of uncertainty on how we could celebrate, we knew what was most important to us was to commit our lives to each other and figure out the party later - so we were legally married on our original wedding date of 10.10.2020 as many of you saw on Zoom! It was a great day enjoyed with our immediate family and supportive wedding party. But we look forward to celebrating with all of our friends, family, and community this fall. It may be a bit different than other weddings you've been to, but we hope you enjoy our unique events and we truly appreciate your support as we step into the next chapter of our story.  </p>
                </Col>
                <Col>
                        <h3>Our Future Plans</h3>
                        <p>A few days after the marriage celebrations, we plan to head to Mexico to celebrate our first wedding anniversary and Chris's birthday by eating too many tacos and enjoying our first vacation since before the pandemic. In 2022, we hope to catch-up on the travel we've missed out on & see some more of the world. We have yet to finalize the destination for our real honeymoon, but we can guarantee that wherever it ends up being will likely involve good places to eat, day spas to unwind in, and lots of sleeping in late.</p>
                    </Col>
                    </Row>
            </Container>
        )
